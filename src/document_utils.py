"""
Contains functions for loading and parsing documents. It provides functionalities to fetch a document from a URL and parse it into a structured format for further processing.
