"""
Provides setup functionalities for creating service contexts and retrievers. This encompasses initializing services with API keys, creating context required for querying, and setting up retrieval systems based on node similarity.
