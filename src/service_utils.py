"""
Provides utilities for creating service contexts and retriever/query engines, encapsulating the setup and integration with external models and services for processing and querying node data.
