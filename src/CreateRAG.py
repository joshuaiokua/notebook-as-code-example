"""
Defines the CreateRAG class, which integrates functionalities for loading and parsing documents, setting up a service context, creating retrievers and query engines, deploying a Retrieval-Augmented Generation (RAG) system, and conducting retrievals and queries. This class provides an encapsulated approach to execute the RAG workflows.
