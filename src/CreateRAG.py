"""
Defines a class for creating a Retrieval-Augmented Generation pipeline. This class encapsulates the whole process from document loading, node parsing, service context creation, retriever, and query engine setup, to deploying the entire pipeline and making retrieval or query requests.
