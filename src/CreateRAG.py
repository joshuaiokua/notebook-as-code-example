"""
Defines the CreateRAG class, which encompasses functionality to load and process a document, create a service context, and set up a retriever and query engine all in one place.
File generated on: 2024-03-09 04:53:13
"""
