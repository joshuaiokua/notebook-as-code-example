"""
Defines the CreateRAG class which encapsulates the entire process of loading a document, parsing it, setting up the service context, creating a retriever, and querying the document. It serves as a high-level interface for retrieval-augmented generation tasks.
File generated on: 2024-02-29 10:24:18
"""
