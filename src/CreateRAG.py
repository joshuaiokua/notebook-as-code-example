"""
Defines the CreateRAG class which encapsulates functionalities for the entire process of loading a document, parsing it, creating a service context, and executing retrieval and query operations on the processed data.
