"""
Defines a class responsible for creating a Retrieve-And-Generate (RAG) pipeline. This includes methods for document processing, service context creation, retriever and query engine setup, and executing queries against the generated model.
