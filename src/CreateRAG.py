"""
Defines the CreateRAG class which encapsulates the process of creating a Retrieve-and-Generate system, including document loading, node parsing, service context creation, retriever and query engine initialization, and execution of retrieve and query operations.
