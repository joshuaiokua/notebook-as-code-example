"""
Defines the CreateRAG class which encapsulates the process of creating a retriever-augmented generation system. This class manages all steps from document loading over node creation to setting up retrievers and query engines.
