"""
This file defines the CreateRAG class, which includes methods for loading and parsing documents, creating service contexts, retrievers, and query engines, and deploying and querying the RAG system.
