"""
Hosts functions and classes related to setting up the service context for the retrieval-based question answering system, including initializing language and embedding models.
