"""
Provides functionalities to create service contexts and retrievers, crucial for setting up the backend services including language models and vector storage for document retrieval.
