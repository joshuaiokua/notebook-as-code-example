"""
Provides functionalities to create service contexts and retrievers which are critical for setting up the retrieval-based question answering system including language model context and embedding models.
