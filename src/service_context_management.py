"""
This file is responsible for creating the service context necessary for the retrieval and query engines, including managing environment variables, initializing language and embedding models.
