"""
Defines the CreateRAG class that encapsulates the functionality for loading and parsing documents, setting up the service context, creating retrievers and query engine, and allows for deploying and querying the setup for document retrievals.
