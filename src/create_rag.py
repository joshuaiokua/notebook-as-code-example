"""
Defines the CreateRAG class which encapsulates the process of creating a Retriever-Answer Generator system. This class includes methods for loading a document, parsing it, setting up the service context with models, creating a retriever, creating a query engine, and finally deploying the entire setup for retrieval and querying operations.
